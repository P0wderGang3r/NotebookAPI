...
def add_user():
	...
	curr_id = int.from_bytes(base64.b64encode(bytes('' + curr_name[0] + curr_password[0] + str(curr_datetime), 'utf-8')), 'big')
	curr_session_id = int.from_bytes(base64.b64encode(bytes('' + curr_name[0] + curr_password[0] + str(curr_datetime), 'utf-8')), 'big')
...
def add_todo():
	...
	curr_todo_id = int.from_bytes(base64.b64encode(bytes('' + curr_user_id[0] + str(curr_datetime), 'utf-8')), 'big')
