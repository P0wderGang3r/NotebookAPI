...
def add_user():
	...
	curr_id = base64.b64encode(bytes('' + curr_name + curr_password + str(curr_datetime), 'utf-8'))
	curr_session_id = base64.b64encode(bytes('' + curr_name + curr_password + str(curr_datetime), 'utf-8'))
...
def add_todo():
	...
	curr_todo_id = base64.b64encode(bytes('' + curr_user_id + str(curr_datetime), 'utf-8'))
